...
public class Constants {
    ...
    public static final String EVENT_NOT_FOUND_MESSAGE = "Event with id=%d not found";
    ...
    public static final String LIKE_NOT_FOUND_MESSAGE = "Like with eventId=%d and userId=%d not found";
